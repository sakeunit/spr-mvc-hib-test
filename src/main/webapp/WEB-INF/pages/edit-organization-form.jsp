    ...
    <div class="container">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h1 class="panel-title"><spring:message code="page.organization.edit.title"/></h1>
        </div>
        <div class="panel-body">
          <p><spring:message code="page.organization.edit.description"/></p>
        </div>
      </div>
      ...
      <form:form class="form-horizontal col-md-12" method="POST" commandName="organization" action="${pageContext.request.contextPath}/organization/add.html">
          ...
          <div class="row form-group form-group-md">
            <label class="col-md-4 control-label"><spring:message code="label.telephone"/></label>
            <div class="col-md-8">
              <form:input class="form-control" path="telephone" /></td>
              <form:errors path="telephone" cssClass="errors"/>
            </div>
          </div>

          <div class="row form-group form-group-md">
            <label class="col-md-4 control-label"><spring:message code="label.address"/></label>
            <div class="col-md-8">
