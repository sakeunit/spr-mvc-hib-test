  ...
  <div class="container">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h1 class="panel-title"><spring:message code="page.teammember.list.title"/></h1>
      </div>
      <div class="panel-body">
        <p><spring:message code="page.teammember.list.description"/></p>
      </div>
    </div>
    ...
    <tr>
      ...
      <th width="18%"><spring:message code="label.firstName"/></th>
      <th width="18%"><spring:message code="label.lastName"/></th>
      <th width="50%"><spring:message code="label.teams"/></th>
    ...
    <tr>
    	<td><span class="label label-info">${teammember.id}</span></td>
    	<td>${teammember.firstName}</td>
    	<td>${teammember.lastName}</td>
    	<td>${teammember.teams}</td>
    	<td>
      	<a class="btn btn-default btn-xs" href="${pageContext.request.contextPath}/teammember/edit/${teammember.id}.html"><spring:message code="page.common.edit"/></a><br/>
      	<a class="btn btn-default btn-xs" href="${pageContext.request.contextPath}/teammember/delete/${teammember.id}.html"><spring:message code="page.common.delete"/></a><br/>
    	</td>
    </tr>
    </c:forEach>
    </tbody>
