...
<body>
  <div class="container">
    ...
    <thead>
    <tr>
    <th width="10%">id</th><th width="15%">First name</th><th width="10%">Last name</th><th width="10%">Actions</th>
    </tr>
    </thead>
    <tbody>
    ...
    <tr>
    	...
    	<td>
    	<a href="${pageContext.request.contextPath}/teammember/edit/${teammember.id}.html">Edit</a><br/>
    	<a href="${pageContext.request.contextPath}/teammember/delete/${teammember.id}.html">Delete</a><br/>
    	</td>
    </tr>
    </c:forEach>
    </tbody>
